...
/**
 * Created by KorHacker on 2017-10-04.
 */
...
public class GPSTracker extends Service implements LocationListener {
    ...
    // The minimum time between update in milliseconds
    ...
    /**
     * Fuction to check if best network provider
     *
     * @return boolean
     */
    ...
    public void showSettingsAlert() {
        ...
        alertDialog.setMessage("GPS is not enabled. Do you want to go setting menu?");
